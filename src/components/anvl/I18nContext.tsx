...
const ru: Dict = {
  ...
  "bot.popover.delete.confirm":
    "Удалить бота окончательно? Сессии и события сохранятся, но webhook будет снят и токен удалён.",
  ...
  "ai.model": "движок",
  "ai.msg.intro": "Я Anvl. Опишите бота, который вы хотите, и я разложу флоу на канвасе.",
  "ai.label": "Anvl",
  "ai.thinking": "Думаю…",
  ...
  "ai.msg.tools_done": "Готово — холст обновлён.",
  "ai.pipeline": "Перенос в визуал",
  "ai.tools.applied": "Применённые операции",
  "ai.tools.reset_canvas": "Очистил холст",
  "ai.tools.add_node": "Добавил блок",
  "ai.tools.connect": "Связал блоки",
  "ai.tools.set_param": "Параметр",
  "ai.tools.set_preview": "Обновил превью чата",
  "ai.tools.set_miniapp": "Обновил Mini App",
  ...
  "node.trigger.webapp_data.label": "Заказ из Mini App",
  "node.trigger.webapp_data.desc": "Срабатывает на sendData из Mini App",
...
const en: Dict = {
  ...
  "bot.popover.delete.confirm":
    "Delete this bot for good? Sessions and events stay, but the webhook is removed and the token is wiped.",
  "platform.telegram": "Telegram",
  "platform.max": "Max",
  "platform.miniapp": "Mini App",
  ...
  "ai.model": "engine",
  "ai.msg.intro": "I'm Anvl. Describe the bot you want and I'll lay out the flow on the canvas.",
  "ai.label": "Anvl",
  ...
  "ai.msg.tools_done": "Done — canvas updated.",
  "ai.pipeline": "Transferring to visual",
  "ai.tools.applied": "Applied operations",
  "ai.tools.reset_canvas": "Cleared canvas",
  "ai.tools.add_node": "Added node",
  "ai.tools.connect": "Connected",
  "ai.tools.set_param": "Param",
  "ai.tools.set_preview": "Updated chat preview",
  "ai.tools.set_miniapp": "Updated Mini App",
  ...
  "node.trigger.webapp_data.label": "Mini App order",
  "node.trigger.webapp_data.desc": "Fires on sendData from a Mini App",
  ...
  "preview.user_msg": "/start",
  "preview.bot_msg_1": "Hi Sasha 👋 Anvl VPN — fast and secure internet. 12 countries, no logs.",
