...
- использовать update_param чтобы изменить params.X на существующей ноде, а не пересоздавать её
